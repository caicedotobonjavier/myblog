    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ocupation', models.CharField(blank=True, max_length=50, verbose_name='Ocupacion')),
                ('genero', models.CharField(blank=True, choices=[('0', 'Masculino'), ('1', 'Femenino'), ('2', 'Otro')], max_length=50, verbose_name='Genero')),
